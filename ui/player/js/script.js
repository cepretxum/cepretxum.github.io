...
/* play_frame */
var play_frame = document.getElementById("play-frame");
...
/* add rerender listener */
fullscreenBtn.addEventListener('click', rerender);
...
function StartPlayVideo(){
	...
	second get into fullscreen
	third :: auto play
	*/
	play_frame.style.visibility="visible";
...
/* rerender function to exit fullscreen */

function rerender(){
	/*
	first exit fullscreen
	second make play_frame invisible
	*/
	exitFullscreen();
	play_frame.style.visibility="hidden";
